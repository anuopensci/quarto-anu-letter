...
\hypersetup{
  ...
  pdfauthor={Alison Doe},
  pdfsubject={collaboration},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
\signature{
Alison Doe}
\address{Australian National University\\Biological Data Science
Institute\\46 Sullivan's Creek Road\\Canberra 2600\\Australia\\[2mm]}
\begin{letter}{Director Doe \& Co\\35 Anthony Road\\Newport\\Ipswich IP3
5RT\\ ~ \\Subject: collaboration}
...
This letter template is heavily inspired by the
\href{https://github.com/mcanouil/quarto-letter}{quarto-letter}.
